...
public class TaxCalculator {
	...
	public static void main(String[] args) {
		...
		System.out.println("Statute types:");
		System.out.println("0-> Single");
		System.out.println("1-> Married jointly");
		System.out.println("2-> Married separately");
		System.out.println("3-> Head of household");
		System.out.print("Enter the Statute: ");
		int statute = input.nextInt();
		double income =  0;
		double tax = 0;
		switch (statute) {
		case 0:
			System.out.print("Enter the value of taxable money:");
		...
		case 3:
			...
			break;
		default:
			System.out.println("invalid statute!");
			break;
		}
